...
|                                                                                                                                              | Name                                   | Description                                                                                                                                                                                                                                                                                       |
| -------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Schedule](assets/icons/calendar-light.svg#only-light){ width="100%" }![Schedule](assets/icons/calendar-dark.svg#only-dark){ width="100%" } | [Nautobot Schedule](schedule/index.md) | A calendaring/scheduling application for [Nautobot]. It can be used to define and assign maintenance or blackout schedules to an object (ex: Device). It uses a subset of [RFC 5545](https://datatracker.ietf.org/doc/html/rfc5545) (wraps `dateutil.rrule`) for specifying recurring date/times. |
