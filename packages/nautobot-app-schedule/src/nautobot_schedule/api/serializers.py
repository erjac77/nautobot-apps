...
class EventSerializer(NautobotModelSerializer):
    ...
    exdate = serializers.ListField(
        child=serializers.DateTimeField(), source="exdates", required=False
    )
    rdate = serializers.ListField(
        child=serializers.DateTimeField(), source="rdates", required=False
    )
...
class ScheduleTypeSerializer(NautobotModelSerializer):
    class Meta:
        model = ScheduleType
        fields = "__all__"
...
class ScheduleSerializer(NautobotModelSerializer):
