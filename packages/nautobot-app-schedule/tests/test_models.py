...
def test_schedule(schedule_factory: ScheduleFactory) -> None:
    schedule = schedule_factory.build(name="My schedule")
    assert str(schedule) == "My schedule"


def test_schedule_type(schedule_type_factory: ScheduleTypeFactory) -> None:
    schedule_type = schedule_type_factory.build(name="My schedule type")
    assert str(schedule_type) == "My schedule type"
